...
def main():
    ...
    win = "TIMWAVE LDR RX V1.0 - H.265 + RIFE + RealESRGAN Stream"
    ...
    try:
        while True:
            ...
            cv2.putText(render, f"TIMWAVE LDR RX V1.0 - H.265", (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 255, 0), 2, cv2.LINE_AA)
